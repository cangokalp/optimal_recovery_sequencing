...
class Network:
    ...
    def shortestPath(self, origin, destination=None, destonly=False, freeflow=False, wo=False, not_elig=None):
            ...
            with open(networkFileName, "r") as networkFile:
                ...
                for line in fileLines[metadata['END OF METADATA']:]:
                    ...
                    self.link[linkID] = Link(self,
                                             ...
                                             float(data[8]),   # Toll
                                             data[9])          # Link type
                    self.original_cap[linkID] = data[2]
                    self.original_fft[linkID] = data[4]
